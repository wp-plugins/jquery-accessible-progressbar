...
function JQueryAccessibleProgressbar_init() {
    ...
    if ( !is_admin() && is_active_widget('widget_JQueryAccessibleProgressbar') ) {
        wp_register_style('jquery.ui.all', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/themes/base/jquery.ui.all.css'));
        wp_enqueue_style('jquery.ui.all');

        wp_deregister_script('jquery');

        // add your own script
        wp_register_script('jquery-1.4.2', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/jquery-1.4.2.js'));
        wp_enqueue_script('jquery-1.4.2');

        wp_register_script('jquery.ui.core', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/ui/jquery.ui.core.js'));
        wp_enqueue_script('jquery.ui.core');

        wp_register_script('jquery.ui.widget', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/ui/jquery.ui.widget.js'));
        wp_enqueue_script('jquery.ui.widget');

        wp_register_script('jquery.ui.button', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/ui/jquery.ui.button.js'));
        wp_enqueue_script('jquery.ui.button');

        wp_register_script('jquery.ui.accordion', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/ui/jquery.ui.accordion.js'));
        wp_enqueue_script('jquery.ui.accordion');

        wp_register_script('jquery.ui.progressbar', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/ui/jquery.ui.progressbar.js'));
        wp_enqueue_script('jquery.ui.progressbar');

        wp_register_style('demos', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/jquery-ui/demos.css'));
        wp_enqueue_style('demos');

        wp_register_script('JQueryAccessibleProgressbar', ( get_bloginfo('wpurl') . '/wp-content/plugins/JQueryAccessibleProgressbar/lib/JQueryAccessibleProgressbar.js'));
