$(function() {
    ...
    $('#radioProgressbar').change(function() {
        ...
        var title = "";
        if(button == "archives") {
            phpAjax = "wp-content/plugins/jquery-accessible-progressbar/getArchivesAjax.php";
            title = "Archives";
        } else if(button == "posts") {
            phpAjax = "wp-content/plugins/jquery-accessible-progressbar/getRecentPostsAjax.php";
            title = "Recent Posts";
        } else if(button == "comments") {
            phpAjax = "wp-content/plugins/jquery-accessible-progressbar/getRecentCommentsAjax.php";
            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    if (!$("#progressMsg").length) {
                        $.ajax({
                            type: "GET",
                            url: "wp-content/plugins/jquery-accessible-progressbar/getTranslationsAjax.php",
                            dataType: "json",
                            success: function(msg){
                                if(button == "archives") {
                                    title = msg["archives"];
